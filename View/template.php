...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Projet 5 mvc ">
    <meta name="author" content="Célestin BOSONGO">
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="home">C.BOSONGO</a>
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <ul class="list-inline text-center">
              ...
              <li class="list-inline-item">
                <a href="https://www.linkedin.com/in/célestin-bosongo-02943b125" target="_blank">
                  <span class="fa-stack fa-lg">
                    <i class="fas fa-circle fa-stack-2x"></i>
              ...
              <li class="list-inline-item">
                <a href="https://github.com/celestin211" target="_blank">
                  <span class="fa-stack fa-lg">
                    <i class="fas fa-circle fa-stack-2x"></i>
            ...
            <p class="copyright text-muted">Copyright &copy; celestinservices.fr/blog 2022</p>
            <?php
            if(isset($_SESSION['userType']) && $_SESSION['userType'] === 'admin')
            {
            ?>
