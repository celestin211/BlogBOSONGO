...
use \BlogBOSONGO\Model\Entity\Post;
...
class ControllerAdmin extends ControllerSecured
{
    ...
    public function resetPassword()
    {
        ...
        $email_body = 'Blog de Celestin BOSOSNGO.\n\n'
                    . 'Bonjour '  . $user->getUsername()
                    . ', veuillez cliquer sur le lien ci-dessous afin de réinitialiser votre mot de passe.\n\n '
                    . Configuration::get("https://celestinservices.fr/BlogBOSONGO/?controller=") . 'https://celestinservices.fr/BlogBOSONGO/login/reset/' . urlencode($user->getUsername()) . '/' . urlencode($user->getValidationKey())
                    . '
                        ---------------
