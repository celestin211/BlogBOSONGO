...
use BlogBOSONGO\Model\Manager\UsersManager;
use BlogBOSONGO\Model\Entity\User;
    ...
    public function register()
    {
            ...
            && $this->request->existsParameter("confirmPassword"))
        {
            ...
            if($password === $confirmPassword)
            {
                ...
                $to = $email;
                $email_subject = "Blog de Célestin BOSONGO";
                ...
                $email_body = 'Bienvenue sur le blog de celestin BOSONGO,
                    
                               Pour activer votre compte, veuillez cliquer sur le lien ci dessous
                               ou copier/coller dans votre navigateur internet.
                               
                               '.Configuration::get("https://celestinservices.fr/BlogBOSONGO/?controller=").'https://celestinservices.fr/BlogBOSONGO/registration/validation/' . urlencode($username) . '/' . urlencode($validationKey).'
